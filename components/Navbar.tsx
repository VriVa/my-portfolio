...
" >
        ...
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-white/90 backdrop-blur-md rounded-lg shadow-lg p-4 mb-4"
          >
            {navItems.map((item) => (
              <a
                key={item.name}
                ...
                className="block py-2 text-gray-700 hover:text-pink-500 transition-colors duration-200"
              >
                {item.name}
              </a>
            ))}
